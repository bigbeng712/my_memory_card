...
questions_list.append(Question('Какой бр у Leopard1', 'восемь и ноль', 'один и ноль', 'восемь и семь', 'рыба'))
...
def next_question():
    ...
    # мы заведем (ниже) свойство window.cur_question. # переходим к следующему вопросу
    window.total += 1
    print('Статистика\n-Всего вопросов:', window.total,'\n-Правильных ответов:', window.score)
    cur_question = randint(0, len(questions_list) - 1)
# если список вопросов закончился - идем сначала
...
cur_question = -1    # по-хорошему такие переменные должны быть свойствами, 
